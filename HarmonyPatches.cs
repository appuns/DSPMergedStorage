...
namespace DSPMergeStorage
{
    class HarmonyPatches
    {
        ...
        public static class UIStorageGrid_DeactiveAllGridGraphics_Postfix
        {
            [HarmonyPostfix]
        ...
        public static class UIStorageWindow_OnUpdate_Patch
        {
            ...
            public static void Postfix(UIStorageWindow __instance)
            {
                ...
                //RectTransform scrollContentRect = scrollArea.GetComponent<RectTransform>();


                //scrollContentRect.sizeDelta = new Vector2(-100, -120);
